...
Route::group(['middleware' => ['XSS']], function ()
{
	...
	{
		{
			Route::post('employees/{employee}', 'EmployeeController@infoUpdate')->name('employees.update');
			Route::post('employeess/{employee}', 'EmployeeController@statusUpdate')->name('employees.statuss');
	...
	Route::prefix('recruitment')->group(function ()
	{
		...
		}
		{
			...
			Route::get('job_interviews/{id}/delete', 'JobInterviewController@destroy')->name('job_interviews.destroy');
                        Route::get('job_interviews/{id}/accepted', 'JobInterviewController@accepted')->name('job_interviews.accepted');
		}
		{
