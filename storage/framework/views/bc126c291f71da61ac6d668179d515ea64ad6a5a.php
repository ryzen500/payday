...
serverSide: true,
ajax: {
url: "<?php echo e(route('general_skill.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('general_skill.store')); ?>",
method: "POST",
...
var target = "<?php echo e(route('general_skill.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('general_skill.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('general_skill.index')); ?>/" + delete_id + '/delete';
...
$('#general_skill_form')[0].reset();
$('#general_skill-table').DataTable().ajax.reload();
});<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/settings/variables_method/JS_DT/general_skills_js.blade.php ENDPATH**/ ?>