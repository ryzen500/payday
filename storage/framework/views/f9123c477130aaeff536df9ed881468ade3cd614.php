                    ...
                    <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="educationLevel-tab" data-toggle="tab" href="#educationLevel"
                               ...
                               aria-selected="true"><?php echo e(__('Add Education Level')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#languageSkills"
                               ...
                               aria-selected="false"><?php echo e(__('Add Language Skills')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#otherSkills"
                               ...
                               aria-selected="false"><?php echo e(__('Add Other Skills')); ?></a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-9">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active pt-0" id="educationLevel" role="tabpanel" aria-labelledby="educationLevel-tab">
                            <h3 class="card-title"><?php echo e(__('Add Education Level')); ?></h3>
                            ...
                            <form method="post" id="education_level_form" class="form-horizontal mb-3" >
                                ...
                                <div class="input-group">
                                    <input type="text" name="education_level_name" id="education_level_name"  class="form-control"
                                           placeholder="<?php echo e(__('Education Level')); ?>">
                                    <input type="submit" name="education_level_submit" id="education_level_submit" class="btn btn-success" value=<?php echo e(trans("file.Save")); ?>>
                                </div>
                            </form>
                            <div class="row">
                        ...
                        <div class="tab-pane fade pt-0" id="languageSkills" role="tabpanel" aria-labelledby="languageSkills-tab">
                            <h3 class="card-title"><?php echo e(__('Add Language Skills')); ?></h3>
                            ...
                            <form method="post" id="language_skill_form" class="form-horizontal mb-3" >
                                ...
                                <div class="input-group">
                                    <input type="text" name="language_skill_name" id="language_skill_name"  class="form-control"
                                           placeholder="<?php echo e(__('Language Skill')); ?>">
                                    <input type="submit" name="language_skill_submit" id="language_skill_submit" class="btn btn-success" value=<?php echo e(trans("file.Save")); ?>>
                                </div>
                            </form>
                            <div class="row">
                                <div class="table-responsive">
                                    <table id="language_skill-table" class="table ">
                                        <thead>
                                        <tr>
                                            <th><?php echo e(trans('file.Language')); ?></th>
                                            <th class="not-exported"><?php echo e(trans('file.action')); ?></th>
                                        </tr>
                                        </thead>
                                    </table>
                        ...
                        <div class="tab-pane fade pt-0" id="otherSkills" role="tabpanel" aria-labelledby="otherSkills-tab">
                            <h3 class="card-title"><?php echo e(__('Add Skills')); ?></h3>
                            ...
                            <form method="post" id="general_skill_form" class="form-horizontal mb-3" >
                                ...
                                <div class="input-group">
                                    <input type="text" name="general_skill_name" id="general_skill_name"  class="form-control"
                                           placeholder="<?php echo e(__('Skill')); ?>">
                                    <input type="submit" name="general_skill_submit" id="general_skill_submit" class="btn btn-success" value=<?php echo e(trans("file.Save")); ?>>
                                </div>
                            </form>
                            <div class="row">
                                <div class="table-responsive">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="EducationLevelModalLabel" class="modal-title"><?php echo e(trans('file.Edit')); ?></h5>
            ...
            <div class="modal-body">
                <form method="post" id="education_level_form_edit" class="form-horizontal"  >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="education_level_edit_submit" id="education_level_edit_submit" class="btn btn-success" value=<?php echo e(trans("file.Edit")); ?> />
                    </div>
                </form>
            </div>
        </div>
...
<div id="LanguageSkillEditModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="LanguageSkillModalLabel" class="modal-title"><?php echo e(trans('file.Edit')); ?></h5>
            ...
            <div class="modal-body">
                <form method="post" id="language_skill_form_edit" class="form-horizontal" >
                    ...
                    <?php echo csrf_field(); ?>
                    <div class="col-md-4 form-group">
                        <label><?php echo e(__('Language Skill')); ?> *</label>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="language_skill_edit_submit" id="language_skill_edit_submit" class="btn btn-success" value=<?php echo e(trans("file.Edit")); ?> />
                    </div>
                </form>
            </div>
        </div>
...
<div id="GeneralSkillEditModal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="GeneralSkillModalLabel" class="modal-title"><?php echo e(trans('file.Edit')); ?></h5>
            ...
            <div class="modal-body">
                <form method="post" id="general_skill_form_edit" class="form-horizontal"  >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="general_skill_edit_submit" id="general_skill_edit_submit" class="btn btn-success" value=<?php echo e(trans("file.Edit")); ?> />
                    </div>
                </form>
            </div>
        </div>
    </div>
</div><?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/settings/variables_method/partials/employee_qualification.blade.php ENDPATH**/ ?>