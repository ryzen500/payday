<?php $__env->startSection('content'); ?>
    ...
    <section>
        ...
        <div class="container-fluid">
            <?php if(Auth::user()->can('store-assets')): ?>
                <button type="button" class="btn btn-info" name="create_record" id="create_record"><i
                    class="fa fa-plus"></i> <?php echo e(__('Add Assets')); ?></button>            
            <?php endif; ?>

            <?php if(Auth::user()->can('delete-assets')): ?>
        ...
        <div class="table-responsive">
            <table id="asset-table" class="table ">
                ...
                <tr>
                    ...
                    <th><?php echo e(__('Company Asset Code')); ?></th>
                    <th><?php echo e(__('Is Working')); ?>?</th>
                    <th><?php echo e(__('Assign To')); ?></th>
                    <th><?php echo e(trans('file.Company')); ?></th>
                    <th><?php echo e(trans('file.Warranty')); ?> <?php echo e(trans('file.Date')); ?></th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('Add Assets')); ?></h5>
                    ...
                    <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Asset Name')); ?> *</label>
                                <input type="text" name="asset_name" id="asset_name" required class="form-control"
                                       placeholder="<?php echo e(__('Asset Name')); ?>">
                            </div>


                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Company Asset Code')); ?> </label>
                                <input type="text" name="asset_code" id="asset_code" class="form-control"
                                       placeholder="<?php echo e(__('Company Asset Code')); ?>">
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="assets_category_id" id="assets_category_id"
                                    ...
                                    <?php $__currentLoopData = $asset_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($asset_category->id); ?>"><?php echo e($asset_category->category_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>

                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Is Working')); ?></label>
                                <select name="status" id="status" class="form-control selectpicker "
                                        data-live-search="true" data-live-search-style="begins"
                                        title='<?php echo e(__('Selecting',['key'=>trans('file.Status')])); ?>...'>
                                    <option value="yes"><?php echo e(trans('file.Yes')); ?></option>
                                    <option value="no"><?php echo e(trans('file.No')); ?></option>
                                    <option value="on maintenance"><?php echo e(__('On Maintenance')); ?></option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(trans('file.Purchase')); ?> <?php echo e(trans('file.Date')); ?> *</label>
                                <input type="text" name="purchase_date" id="purchase_date" required
                                       class="form-control date" autocomplete="off" value="">
                            </div>

                            <div class="col-md-6 form-group">
                                <label><?php echo e(trans('file.Warranty/AMC')); ?> <?php echo e(__('End Date')); ?> *</label>
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(trans('file.Manufacturer')); ?> *</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(__('Asset Note')); ?></label>
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(trans('file.Assets')); ?> <?php echo e(__('Image')); ?> </label>
    ...
    <div class="modal fade" id="asset_modal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><?php echo e(__('Assets Info')); ?></h4>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table  table-bordered">
                                    ...
                                    <tr>
                                        <th><?php echo e(trans('file.Manufacturer')); ?></th>
                                        <td id="manufacturer_show"></td>
                                    </tr>

                                    <tr>
                                        <th><?php echo e(trans('file.Purchase')); ?> <?php echo e(trans('file.Date')); ?></th>
                                        <td id="purchase_date_show"></td>
                                    </tr>

                                    <tr>
                                        <th><?php echo e(trans('(file.Warranty/AMC')); ?> <?php echo e(__('End Date')); ?></th>
                                    ...
                                    <tr>
                                        <th><?php echo e(__('Assets Info')); ?></th>
                                        <td id="asset_note_show"></td>
                                    </tr>


                                    <tr>
                                        <th><?php echo e(trans('file.Assets')); ?> <?php echo e(__('Image')); ?></th>
        ...
        (function($) { 
            ...
            $(document).ready(function () {
                ...
                let table_table = $('#asset-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('assets.index')); ?>",
                    },
            ...
            $('#create_record').on('click', function () {
                ...
                $('.modal-title').text('<?php echo e(__('Add Assets')); ?>');
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                if ($('#action').val() == '<?php echo e(trans("file.Edit")); ?>') {
                    $.ajax({
                        url: "<?php echo e(route('assets.update')); ?>",
                        method: "POST",
                        data: new FormData(this),
                        contentType: false,
                        cache: false,
            ...
            $(document).on('click', '.show_new', function () {
                ...
                let target = '<?php echo e(route('assets.index')); ?>/' + id;
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result.data.asset_image) {
                            let d_link = '<?php echo e(route('assets.download')); ?>/' + id;
                            $('#asset_image_show_link').html('<a href="' + d_link + '"><strong><?php echo e(__('Download')); ?></strong></a><br>');
                            $('#asset_image_show').html("<img src=<?php echo e(URL::to('/public')); ?>/uploads/asset_file/" + result.data.asset_image + " width='70'  class='img-thumbnail' />");

                        }

                        $('#asset_modal').modal('show');
                        $('.modal-title').text('<?php echo e(__('Assets Info')); ?>');
                    }
                });
            });
            ...
            $(document).on('click', '.edit', function () {
                ...
                let target = "<?php echo e(route('assets.index')); ?>/" + id + '/edit';
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        ...
                        if (html.data.asset_image) {
                            let d_link = '<?php echo e(route('assets.download')); ?>/' + id;
                            $('#asset_logo_link').html('<a href="' + d_link + '"><strong><?php echo e(__('Download')); ?></strong></a><br>');
                            $('#asset_logo').html("<img src=<?php echo e(URL::to('/public')); ?>/uploads/asset_file/" + html.data.asset_image + " width='70'  class='img-thumbnail' />");
            ...
            $(document).on('click', '#bulk_delete', function () {
                ...
                if (id.length > 0) {
                    if (confirm('<?php echo e(__('Delete Selection',['key'=>trans('file.Asset Info')])); ?>')) {
                        $.ajax({
                            url: '<?php echo e(route('mass_delete_assets')); ?>',
                            method: 'POST',
                            data: {
                                assetIdArray: id
                            },
            ...
            $('#ok_button').on('click', function () {
                let target = "<?php echo e(route('assets.index')); ?>/" + delete_id + '/delete';
                $.ajax({
                    url: target,
                    beforeSend: function () {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\peoplepro\resources\views/assets/index.blade.php ENDPATH**/ ?>