...
serverSide: true,
ajax: {
url: "<?php echo e(route('education_level.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('education_level.store')); ?>",
method: "POST",
...
var target = "<?php echo e(route('education_level.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('education_level.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('education_level.index')); ?>/" + delete_id + '/delete';
...
$('#education_level_form')[0].reset();
$('#education_level-table').DataTable().ajax.reload();
});<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/settings/variables_method/JS_DT/employee_qualification_js.blade.php ENDPATH**/ ?>