...
<?php $__env->startSection('content'); ?>
    ...
    <section>
        ...
        <div class="container-fluid mb-3">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('store-job_interview')): ?>
                <button type="button" class="btn btn-info" name="create_record" id="create_record"><i
                            class="fa fa-plus"></i> <?php echo e(__('Add Interview')); ?></button>
            <?php endif; ?>
        </div>
        ...
        <div class="table-responsive">
            <table id="job_interview-table" class="table ">
                ...
                <tr>
                    ...
                    <th><?php echo e(__('Interview Place')); ?></th>
                    <th><?php echo e(__('Interview Date & Time')); ?></th>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('Add Interview')); ?></h5>
                    ...
                    <form autocomplete="off" method="post" id="sample_form" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="job_id"><?php echo e(__('Job Title')); ?> *</label>
                                <select name="job_id" id="job_id" required class="form-control selectpicker candidate"
                                        data-live-search="true" data-live-search-style="begins"
                                        title="<?php echo e(__('Selecting',['key'=>__('Job Title')])); ?>...">
                            ...
                            <div class="col-md-6 form-group">
                                <label for="candidate_id"><?php echo e(trans('file.Candidates')); ?> *</label>
                                <select name="candidate_id[]" id="candidate_id" required
                                        class="selectpicker form-control"
                                        data-live-search="true" data-live-search-style="begins" multiple
                                        title='<?php echo e(__('Selecting',['key'=>trans('file.Candidates')])); ?>...'>
                                </select>
                            </div>

                            <div class="col-md-6 form-group">
                                <label for="interview_place"><?php echo e(__('Interview Place')); ?> *</label>
                                <input type="text" name="interview_place" id="interview_place" required
                                       class="form-control"
                                       placeholder="<?php echo e(__('Interview Place')); ?>">
                            </div>

                            <div class="col-md-6 form-group">
                                <label for="interview_date"><?php echo e(__('Interview Date')); ?></label>
                                <input type="text" name="interview_date" id="interview_date" class="form-control date"
                                       placeholder="<?php echo e(__('Interview Date')); ?>">
                            </div>

                            <div class="col-md-6 form-group">
                                <label for="interview_time"><?php echo e(__('Interview Time')); ?></label>
                                <input type="text" name="interview_time" id="interview_time" required
                                       class="form-control time"
                                       placeholder="<?php echo e(__('Interview Time')); ?>">
                            </div>

                            <div class="col-md-6 form-group">
                                <label for="employee_id"><?php echo e(trans('file.Interviewers')); ?> *</label>
                                <select name="employee_id[]" id="employee_id" required class="form-control selectpicker"
                                        data-live-search="true" data-live-search-style="begins" multiple
                                        title='<?php echo e(__('Selecting',['key'=>trans('file.Interviewers')])); ?>...'>
    ...
    <div class="modal fade" id="interview_model" tabindex="-1" role="dialog" aria-labelledby="basicModal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><?php echo e(__('Interview Info')); ?></h4>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table  table-bordered">
                                    ...
                                    <tr>
                                        <th><?php echo e(trans('file.Employer')); ?></th>
                                    ...
                                    <tr>
                                        <th><?php echo e(__('Interview Date')); ?></th>
                                        <td id="show_interview_date"></td>
                                    </tr>

                                    <tr>
                                        <th><?php echo e(__('Interview Time')); ?></th>
                                        <td id="show_interview_time"></td>
                                    </tr>


                                    <tr>
                                        <th><?php echo e(__('Selected Candidates')); ?></th>
                                        <td id="show_candidates"></td>
                                    </tr>

                                    <tr>
                                        <th><?php echo e(trans('file.Interviewers')); ?></th>
    ...
    <div id="acceptedModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 align="center"><?php echo e(__('Are you sure you want to accept this candidate?')); ?></h4>
                </div>
                <div class="modal-footer">
                    <button type="button" name="accept_button" id="accept_button" class="btn btn-danger"><?php echo e(trans('file.OK')); ?>
        ...
        (function($) {  
            ...
            $(document).ready(function () {
                ...
                let table_table = $('#job_interview-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('job_interviews.index')); ?>",
                    },
            ...
            $('#create_record').on('click', function () {
                ...
                $('.modal-title').text('<?php echo e(__('Add interview')); ?>');
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('job_interviews.store')); ?>",
                    method: "POST",
            ...
            $(document).on('click', '.details', function () {
                ...
                let target = '<?php echo e(route('job_interviews.index')); ?>/' + id;
            ...
            $(document).on('click', '.accepted', function () {
                ...
                $('#accept_button').text('<?php echo e(trans('file.OK')); ?>');
            ...
            $('#ok_button').on('click', function () {
                let target = "<?php echo e(route('job_interviews.index')); ?>/" + delete_id + '/delete';
                $.ajax({
                    url: target,
                    beforeSend: function () {
            ...
            $('#accept_button').on('click', function () {
                let target = "<?php echo e(route('job_interviews.index')); ?>/" + accept_id + '/accepted';
                $.ajax({
                    url: target,
                    beforeSend: function () {
            ...
            $('.candidate').change(function () {
                if ($(this).val() !== '') {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('dynamic_candidate')); ?>",
                        method: "POST",
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/payday/resources/views/recruitment/job_interview/index.blade.php ENDPATH**/ ?>