                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(__('Parent Name')); ?></label>
                                    <select name="parent_id" id="parent_id"
                                        class="form-control"
                                        title="<?php echo e(__('Selecting Parent Departement')); ?>...">
                                        <?php $__currentLoopData = $parent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($parents->id); ?>"> <?php echo e($parents->department_name); ?></option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="employee_id" id="employee_id" class="selectpicker form-control"
                                        ...
                                        <?php $__currentLoopData = $department_head; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department_heads): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($department_heads->id); ?>"><?php echo e($department_heads->first_name); ?> <?php echo e($department_heads->last_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/payday/resources/views/organization/department/index.blade.php ENDPATH**/ ?>