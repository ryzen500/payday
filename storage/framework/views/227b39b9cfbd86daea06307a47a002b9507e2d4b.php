...
serverSide: true,
ajax: {
url: "<?php echo e(route('travel_method.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('travel_method.store')); ?>",
method: "POST",
...
var target = "<?php echo e(route('travel_method.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('travel_method.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('travel_method.index')); ?>/" + delete_id + '/delete';
...
$('#travel_method_form')[0].reset();
$('#travel_method-table').DataTable().ajax.reload();
});<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/settings/variables_method/JS_DT/travel_method_js.blade.php ENDPATH**/ ?>