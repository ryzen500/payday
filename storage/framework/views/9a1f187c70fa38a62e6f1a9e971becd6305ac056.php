...
serverSide: true,
ajax: {
url: "<?php echo e(route('training_type.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('training_type.store')); ?>",
method: "POST",
data: { type:type},
...
var target = "<?php echo e(route('training_type.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('training_type.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('training_type.index')); ?>/" + delete_id + '/delete';
...
$('#training_type_form')[0].reset();
$('#training_type-table').DataTable().ajax.reload();
});<?php /**PATH /var/www/html/payday/resources/views/training/training_type/training_type_js.blade.php ENDPATH**/ ?>