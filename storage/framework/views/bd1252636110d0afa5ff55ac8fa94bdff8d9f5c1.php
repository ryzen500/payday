<?php $__env->startSection('content'); ?>
                            ...
                            <div class="row">
                                    ...
                                    <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                                <a class="nav-link" href=""
                                                    id="salary-details-tab" data-toggle="tab"
                                                    data-table="salary-details"
                                                    data-target="#salary-details"                  
                                                    role="tab" aria-controls="Salary Details"
                                                    aria-selected="false"><?php echo e(__('Salary Details')); ?></a>
                                            </li>  
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link"href="<?php echo e(route('employees.details',$employee)); ?>"
                                            id="manager_data-tab" data-toggle="tab" data-table="manager_data"
                                            data-target="#Manager_data" role="tab" aria-controls="Manager_data"
                                            aria-selected="false"><?php echo e(__('Manager Data')); ?></a>
                                        </li>
                                    </ul>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="col-md-9">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="Basic" role="tabpanel"
                                            ...
                                            <form method="post" id="basic_sample_form" class="form-horizontal"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label><?php echo e(__('NIK')); ?></label>
                                                         <input type="text" name="nik" id="nik"
                                                            class="form-control"
                                                            placeholder="<?php echo e(__('NIK')); ?>"
                                                            value="<?php echo e($employee->nik); ?>"
                                                            >
                                                    </div>

                                                    <div class="col-md-4 form-group">
                                                        <label><?php echo e(__('NPWP')); ?></label>
                                                         <input type="text" name="npwp" id="npwp"
                                                            class="form-control"
                                                            placeholder="<?php echo e(__('NPWP')); ?>"
                                                            value="<?php echo e($employee->npwp); ?>"
                                                            >
                                                    </div>

                                                    <div class="col-md-4 form-group">
                                                        <label><?php echo e(__('BPJS')); ?></label>
                                                        <select name="bpjs" id="bpjs"
                                                                class="selectpicker form-control"
                                                                title="<?php echo e(__('Selecting BPJS Type')); ?>...">
                                                                <?php if($employee->bpjs == 'bpjs_tk') { ?>
                                                                    <option selected value="bpjs_tk"><?php echo e(trans('BPJS TK')); ?></option>
                                                                    <option value="bpjs_kesehatan"><?php echo e(trans('BPJS Kesehatan')); ?></option>
                                                                <?php } elseif($employee->bpjs == 'bpjs_kesehatan') { ?>
                                                                    <option value="bpjs_tk"><?php echo e(trans('BPJS TK')); ?></option>
                                                                    <option selected value="bpjs_kesehatan"><?php echo e(trans('BPJS Kesehatan')); ?></option>
                                                                <?php } else { ?>
                                                                    <option value="bpjs_tk"><?php echo e(trans('BPJS TK')); ?></option>
                                                                    <option value="bpjs_kesehatan"><?php echo e(trans('BPJS Kesehatan')); ?></option>
                                                                <?php } ?>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label><?php echo e(__('No. Asuransi')); ?></label>
                                                         <input type="text" name="asuransi" id="asuransi"
                                                            class="form-control"
                                                            placeholder="<?php echo e(__('No. Asuransi')); ?>"
                                                            value="<?php echo e($employee->asuransi); ?>"
                                                            >
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <select name="designation_id" id="designation_id"
                                                                ...
                                                                data-live-search="true"
                                                                data-live-search-style="begins"
                                                                title="<?php echo e(__('Selecting Job Position')); ?>...">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-details-employee')): ?>
                                        <div class="tab-pane fade" id="salary-details" role="tabpanel"
                                                aria-labelledby="salary-details">
                                                <?php echo e(__('Salary Detils')); ?>
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $salary_detils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary_detil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <th><?= $salary_detil->salary ?></th>
                                                                <th><?= $salary_detil->title ?></th>
                                                                <th><?= $salary_detil->amount ?></th>
                                                            </tr>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </tbody>
                                                </table>
                                        ...
                                        <div class="tab-pane fade" id="Manager_data" role="tabpanel"
                                             aria-labelledby="manager_data-tab">
                                            <?php echo e(__('Manager Data')); ?>

                                            <hr>
                                            <?php echo $__env->make('employee.manager_data.tampil', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('[data-table="manager_data"]').one('click', function (e) {
            // <?php echo $__env->make('employee.manager_data.index_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\payday\resources\views/employee/dashboard.blade.php ENDPATH**/ ?>