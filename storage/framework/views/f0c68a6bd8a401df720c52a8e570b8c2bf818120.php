            ...
            $(document).on('click', '.show_new', function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#award_photo_id').html("<img src=<?php echo e(URL::to('/public')); ?>/uploads/award_photos/" + result.data.award_photo + " width='70'  class='img-thumbnail' />");
            ...
            $(document).on('click', '.edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (html) {
                        ...
                        $('#store_award_photo').html("<img src=<?php echo e(URL::to('/public')); ?>/uploads/award_photos/" + html.data.award_photo + " width='70'  class='img-thumbnail' />");
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/core_hr/award/index.blade.php ENDPATH**/ ?>