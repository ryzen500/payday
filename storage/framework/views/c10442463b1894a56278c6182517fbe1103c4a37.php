...
<?php $__env->startSection('content'); ?>
    ...
    <section>
        ...
        <div class="container-fluid">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('store-trainer')): ?>
                <button type="button" class="btn btn-info" name="create_record" id="create_record"><i
                            class="fa fa-plus"></i> <?php echo e(__('Add Trainer')); ?></button>
            <?php endif; ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('Add Trainer')); ?></h5>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="sample_form" class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="expertise"><?php echo e(trans('file.Expertise')); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="address"><?php echo e(trans('file.Address')); ?></label>
    ...
    <div class="modal fade" id="trainer_modal" tabindex="-1" role="dialog" aria-labelledby="basicModal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><?php echo e(__('Trainer Info')); ?></h4>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table  table-bordered">
                                    <tr>
                                        <th><?php echo e(__('Trainer Name')); ?></th>
                                    ...
                                    <tr>
                                        <th><?php echo e(trans('file.Expertise')); ?></th>
        ...
        (function($) {
            ...
            $(document).ready(function () {
                ...
                $('#trainer-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('trainers.index')); ?>",
                    },
            ...
            $('#create_record').on('click', function () {
                ...
                $('.modal-title').text('<?php echo e(__('Add Trainer')); ?>');
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                if ($('#action').val() == '<?php echo e(trans('file.Add')); ?>') {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('trainers.store')); ?>",
                        method: "POST",
                ...
                if ($('#action').val() == '<?php echo e(trans('file.Edit')); ?>') {
                    $.ajax({
                        url: "<?php echo e(route('trainers.update')); ?>",
                        method: "POST",
                        data: new FormData(this),
                        contentType: false,
                        cache: false,
            ...
            $(document).on('click', '.show_new', function () {
                ...
                var target = '<?php echo e(route('trainers.index')); ?>/' + id;
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('.modal-title').text("<?php echo e(__('Trainer Info')); ?>");
                    }
                });
            });
            ...
            $(document).on('click', '.edit', function () {
                ...
                var target = "<?php echo e(route('trainers.index')); ?>/" + id + '/edit';
            ...
            $(document).on('click', '#bulk_delete', function () {
                ...
                if (id.length > 0) {
                    if (confirm('<?php echo e(__('Delete Selection',['key'=>trans('file.Trainer')])); ?>')) {
                        $.ajax({
                            url: '<?php echo e(route('mass_delete_trainers')); ?>',
                            method: 'POST',
                            data: {
                                trainerIdArray: id
                            },
            ...
            $('#ok_button').on('click', function () {
                let target = "<?php echo e(route('trainers.index')); ?>/" + delete_id + '/delete';
                $.ajax({
                    url: target,
                    beforeSend: function () {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/payday/resources/views/training/trainer/index.blade.php ENDPATH**/ ?>