...
serverSide: true,
ajax: {
url: "<?php echo e(route('job_categories.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('job_categories.store')); ?>",
method: "POST",
...
var target = "<?php echo e(route('job_categories.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('job_categories.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('job_categories.index')); ?>/" + delete_id + '/delete';
...
$('#job_category_form')[0].reset();
$('#job_category-table').DataTable().ajax.reload();
});<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/settings/variables_method/JS_DT/job_category_js.blade.php ENDPATH**/ ?>