	...
	function convertData(date){
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                if ($('#action').val() == '<?php echo e(trans('file.Edit')); ?>') {
                    ...
                    let start_date_edit = new Date(convertData($("#start_date").val()));
                    let end_date_edit = new Date(convertData($("#end_date").val()));
                    let timeDiff_edit;
                    let dayDiff_edit;
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/payday/resources/views/timesheet/leave/index.blade.php ENDPATH**/ ?>