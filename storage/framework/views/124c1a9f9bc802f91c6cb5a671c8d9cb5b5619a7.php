...
serverSide: true,
ajax: {
url: "<?php echo e(route('document_type.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('document_type.store')); ?>",
method: "POST",
...
var target = "<?php echo e(route('document_type.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('document_type.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('document_type.index')); ?>/" + delete_id + '/delete';
...
<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/settings/variables/JS_DT/document_type_js.blade.php ENDPATH**/ ?>