...
<?php $__env->startSection('content'); ?>
    ...
    <section>
        ...
        <div class="container-fluid mb-3">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('store-promotion')): ?>
                <button type="button" class="btn btn-info" name="create_record" id="create_record"><i
                            class="fa fa-plus"></i> <?php echo e(__('Add Promotion')); ?></button>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('store-promotion')): ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('Add Promotion')); ?></h5>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="sample_form" class="form-horizontal">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="department_id" id="department_id" required
                                        ...
                                        <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($departments->id); ?>"> <?php echo e($departments->department_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="employee_id" id="employee_id" required
                                        ...
                                        <?php $__currentLoopData = $pegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawais): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($pegawais->id); ?>"> <?php echo e($pegawais->first_name); ?> <?php echo e($pegawais->last_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                <label><?php echo e(__('Promotion Date')); ?></label>
    ...
    <div class="modal fade" id="promotion_modal" tabindex="-1" role="dialog" aria-labelledby="basicModal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><?php echo e(__('Promotion Info')); ?></h4>
        ...
        (function($) {
            ...
            $(document).ready(function () {
                ...
                let table_table = $('#promotion-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('promotions.index')); ?>",
                    },
            ...
            $('#create_record').on('click', function () {
                ...
                $('.modal-title').text('<?php echo e(__('Add Promotion')); ?>');
            ...
            $('#sample_form').on('submit', function (event) {
                ...
                if ($('#action').val() == '<?php echo e(trans('file.Add')); ?>') {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('promotions.store')); ?>",
                        method: "POST",
                ...
                if ($('#action').val() == '<?php echo e(trans('file.Edit')); ?>') {
                    $.ajax({
                        url: "<?php echo e(route('promotions.update')); ?>",
                        method: "POST",
                        data: new FormData(this),
                        contentType: false,
                        cache: false,
            ...
            $(document).on('click', '.show_new', function () {
                ...
                let target = '<?php echo e(route('promotions.index')); ?>/' + id;
            ...
            $(document).on('click', '.edit', function () {
                ...
                let target = "<?php echo e(route('promotions.index')); ?>/" + id + '/edit';
            ...
            $(document).on('click', '#bulk_delete', function () {
                ...
                if (id.length > 0) {
                    if (confirm('<?php echo e(__('Delete Selection',['key'=>trans('file.Promotion')])); ?>')) {
                        $.ajax({
            ...
            $('#ok_button').on('click', function () {
                let target = "<?php echo e(route('promotions.index')); ?>/" + delete_id + '/delete';
                $.ajax({
                    url: target,
                    beforeSend: function () {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/payday/resources/views/core_hr/promotion/index.blade.php ENDPATH**/ ?>