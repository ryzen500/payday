                    ...
                    <form action="" method="GET" id="filter_form">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                <label class="text-bold"><b>Job Position</b></label>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="text-bold"><?php echo e(__('Data Manager')); ?> <span class="text-danger">*</span></label>
                                <select name="status_user" id="status_user" class="selectpicker form-control"
                                        data-live-search="true" data-live-search-style="begins"
                                        title="<?php echo e(__('Selecting',['key'=>__('Data Manager')])); ?>...">
                            ...
                            <div class="col-md-6 form-group">
                                <label class="text-bold">Job Position <span class="text-danger">*</span></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\payday\resources\views/employee/index.blade.php ENDPATH**/ ?>