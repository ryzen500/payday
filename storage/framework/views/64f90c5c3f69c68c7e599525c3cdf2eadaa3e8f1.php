    ...
    let table_table = $('#employee_travel-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('employee_travel.index',$employee->id)); ?>",
        },
    ...
    return data.purpose_of_visit + "<br><br><td><b><i><?php echo e(__('Expected Budget :')); ?></i></b>"+ data.expected_budget + "</td><br>" +
    "<td><b><i><?php echo e(__('Actual Budget :')); ?></i></b>" + data.actual_budget + "</td>"
    ...
    $(document).on('click', '.show_travel', function () {
        ...
        let target = '<?php echo e(route('employee_travel.details')); ?>/' + id;
...
<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/employee/core_hr/travel/index_js.blade.php ENDPATH**/ ?>