...
serverSide: true,
ajax: {
url: "<?php echo e(route('language_skill.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('language_skill.store')); ?>",
method: "POST",
...
var target = "<?php echo e(route('language_skill.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('language_skill.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('language_skill.index')); ?>/" + delete_id + '/delete';
...
$('#language_skill_form')[0].reset();
$('#language_skill-table').DataTable().ajax.reload();
});<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/settings/variables_method/JS_DT/language_skills_js.blade.php ENDPATH**/ ?>