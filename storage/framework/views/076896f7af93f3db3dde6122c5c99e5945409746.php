    ...
    let table_table = $('#employee_training-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('employee_training.index',$employee->id)); ?>",
        },
    ...
    $(document).on('click', '.show_training', function () {
        ...
        let target = '<?php echo e(route('employee_training.details')); ?>/' + id;
...
<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/employee/core_hr/training/index_js.blade.php ENDPATH**/ ?>