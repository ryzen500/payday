                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-block">
                                    <div id="accordion">
                                        ...
                                        <div class="card mb-2">
                                            <div class="card-header"> <a class="text-dark collapsed" data-toggle="collapse" href="#set_other_payments" aria-expanded="false"> <strong><?php echo e(__('Other Payment')); ?></strong></a> &nbsp; <a href="#" data-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, 0 amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a> </div>
                        ...
                        <form method="get" id="payment_form" class="form-horizontal" >
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                   ...
                                   <div class="col-md-6 hide-element">
                                       <div class="form-group">
                                           <label for="worked_amount"><?php echo e(__('Amount')); ?></label> <a href="#" data-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, the last month's amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Total Allowance')); ?></label> <a href="#" data-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, the last month's amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(trans('Commissions')); ?></label> <a href="#" data-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, 0 amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Total Overtime')); ?></label> <a href="#" data-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, 0 amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a>
                                   ...
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           <label for="name"><?php echo e(__('Other Payment')); ?></label> <a href="#" data-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, 0 amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a>
                                   ...
                                   <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name"><?php echo e(__('Statutory deductions')); ?></label> <a href="#" data-toggle="popover" data-placement="top" data-content="If you don't set this month's amount, the last month's amount will be treated as this month"><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i></a>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <span><strong><?php echo e(trans('file.NOTE')); ?>:</strong> <?php echo e(__('Total Allowance,Commissions,Total Loan,Total Overtime,Statutory deductions,Other Payment, Pension are not editable.')); ?></span>
                                    </div>
                                </div>
                        ...
                        columns: [
                            ...
                            // },
                            {
                                ...
                                render: function (data) {
                                    console.log('<?php echo e(config('variable.currency')); ?>');
                                    console.log(formatRupiah('<?php echo e(config('variable.currency')); ?>' + data));
                                    if ('<?php echo e(config('variable.currency_format') =='suffix'); ?>') {
                                        // return data + ' <?php echo e(config('variable.currency')); ?>';
                                        return formatRupiah(data + ' <?php echo e(config('variable.currency')); ?>');

                                    } else {
                                        // return '<?php echo e(config('variable.currency')); ?> ' + data;
                                        return '<?php echo e(config('variable.currency')); ?>'+ formatRupiah('<?php echo e(config('variable.currency')); ?>' + data);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\payday\resources\views/salary/pay_list/index.blade.php ENDPATH**/ ?>