...
serverSide: true,
ajax: {
url: "<?php echo e(route('warning_type.index')); ?>",
...
$.ajax({
url: "<?php echo e(route('warning_type.store')); ?>",
method: "POST",
...
var target = "<?php echo e(route('warning_type.index')); ?>/"+id+'/edit';
$.ajax({
url:target,
dataType:"json",
...
$.ajax({
url: "<?php echo e(route('warning_type.update')); ?>",
method: "POST",
...
let target = "<?php echo e(route('warning_type.index')); ?>/" + delete_id + '/delete';
...
$('#warning_type_form')[0].reset();
$('#warning_type-table').DataTable().ajax.reload();
});<?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/settings/variables/JS_DT/warning_type_js.blade.php ENDPATH**/ ?>