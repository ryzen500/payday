...
<div class="modal fade" id="EditformModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
          ...
          <form action="" method="POST" id="updatetForm">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    data-live-search="true" data-live-search-style="begins"  title='<?php echo e(__('Selecting',['key'=>trans('file.Company')])); ?>'>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6" id="designation-selection">
                    <select name="employee_id" id="employeeIdEdit" class="form-control selectpicker" data-live-search="true" data-live-search-style="begins"  title='<?php echo e(__('Selecting',['key'=>trans('file.Employee')])); ?>'>
  ...
  <script>
    $('#companyIdEdit').change(function() {
            ...
            if (companyIdEdit){
                $.get("<?php echo e(route('performance.appraisal.get-employee')); ?>",{company_id:companyIdEdit}, function (data) {
...
</script><?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/performance/appraisal/edit-modal.blade.php ENDPATH**/ ?>