...
<?php $__env->startSection('content'); ?>
    ...
    <section>
        <div class="container-fluid">
            <div class="card">
                <div class="card-header"><h3 class="card-title"><?php echo e(__('Add Payees')); ?></h3></div>
                <div class="card-body">
                    <form method="post" id="payees_form" class="form-horizontal" >
                        ...
                        <div class="input-group">
                            <input type="text" name="payee_name" id="payee_name"  required class="form-control required"
                                   placeholder="<?php echo e(__('Payee Name')); ?>">
                            ...
                            <input type="submit" name="payees_form_submit" id="payees_form_submit" class="btn btn-success" value=<?php echo e(trans("file.Save")); ?>>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 id="PayeesModalLabel" class="modal-title"><?php echo e(trans('file.Edit')); ?></h5>
                    ...
                    <div class="modal-body">
                        <form method="post" id="payees_form_edit" class="form-horizontal" enctype="multipart/form-data" >
                            ...
                            <div class="col-md-4 form-group">
                                <label><?php echo e(__('Payee Name')); ?> *</label>
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="submit" name="payees_edit_submit" id="payees_edit_submit" class="btn btn-success" value=<?php echo e(trans("file.Edit")); ?> />
                            </div>
                        </form>
                    </div>
                </div>
        ...
        (function($) { 
            ...
            $(document).ready(function() {
                var table_table = $('#payees-table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "<?php echo e(route('payees.index')); ?>",
                ...
                $('#payees_form_submit').on('click', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('payees.store')); ?>",
                        method: "POST",
                ...
                $(document).on('click', '.edit', function(){
                    ...
                    var target = "<?php echo e(route('payees.index')); ?>/"+id+'/edit';
                    $.ajax({
                        url:target,
                        dataType:"json",
                ...
                $('#payees_edit_submit').on('click', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('payees.update')); ?>",
                        method: "POST",
                ...
                $(document).on('click', '.delete', function() {
                    ...
                    let target = "<?php echo e(route('payees.index')); ?>/" + delete_id + '/delete';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache2/htdocs/demo/payday/resources/views/finance/payees/payees.blade.php ENDPATH**/ ?>