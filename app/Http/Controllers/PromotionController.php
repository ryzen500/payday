...
class PromotionController extends Controller {
	...
	public function index()
	{
		...
		$pegawai = Employee::select('id', 'first_name', 'last_name', 'company_id')->where('company_id', $company_id)->get();
		...
		if ($logged_user->can('view-promotion'))
		{
			...
			return view('core_hr.promotion.index', compact('companies', 'employees', 'pegawai', 'department'));
		}
