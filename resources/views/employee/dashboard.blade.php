                                    ...
                                    <ul class="nav nav-tabs vertical" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                                <a class="nav-link" href=""
                                                    ...
                                                    aria-selected="false">{{ __('Salary Details') }}</a>
                                            </li>  
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            {{-- <a class="nav-link" href="{{route('employees.show',$employee)}}"
                                               id="manager_data-tab" data-toggle="tab" data-table="manager_data"
                                               data-target="#Manager_data" role="tab" aria-controls="Manager_data"
                                               aria-selected="false">{{__('Manager Data')}}</a> --}}
                                               
                                            <a class="nav-link"href="{{route('employees.details',$employee)}}"
                                            id="manager_data-tab" data-toggle="tab" data-table="manager_data"
                                            data-target="#Manager_data" role="tab" aria-controls="Manager_data"
                                            aria-selected="false">{{__('Manager Data')}}</a>
                                        </li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <select name="bpjs" id="bpjs"
                                                                ...
                                                                title="{{ __('Selecting BPJS Type') }}...">
                                                                <?php if($employee->bpjs == 'bpjs_tk') { ?>
                                                                    <option selected value="bpjs_tk">{{trans('BPJS TK')}}</option>
                                                                    <option value="bpjs_kesehatan">{{trans('BPJS Kesehatan')}}</option>
                                                                <?php } elseif($employee->bpjs == 'bpjs_kesehatan') { ?>
                                                                    <option value="bpjs_tk">{{trans('BPJS TK')}}</option>
                                                                    <option selected value="bpjs_kesehatan">{{trans('BPJS Kesehatan')}}</option>
                                                                <?php } else { ?>
                                                                    <option value="bpjs_tk">{{trans('BPJS TK')}}</option>
                                                                    <option value="bpjs_kesehatan">{{trans('BPJS Kesehatan')}}</option>
                                                                <?php } ?>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        <label>{{__('No. Asuransi')}}</label>
                                                         <input type="text" name="asuransi" id="asuransi"
                                                            class="form-control"
                                                            placeholder="{{__('No. Asuransi')}}"
                                                            value="{{$employee->asuransi}}"
                                                            >
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <select name="designation_id" id="designation_id"
                                                                ...
                                                                data-live-search="true"
                                                                data-live-search-style="begins"
                                                                title="{{__('Selecting Job Position')}}...">
...
{{-- 
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>{{trans('Manager Data')}}</label>
                                                            <select name="status_user" id="status_user"
                                                                    class="form-control selectpicker"
                                                                    data-live-search="true"
                                                                    data-live-search-style="begins"
                                                                    title="{{__('Selecting',['key'=>trans('Data Manager')])}}...">
                                                                @foreach($employess as $employees)
                                                                    <option value="{{$employees->id}}" {{ ($employee->status_user == $employees->id) ? "selected" : '' }}>{{$employees->first_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div> --}}
                                        ...
                                        <div class="tab-pane fade" id="salary-details" role="tabpanel"
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        @foreach ($salary_detils as $salary_detil)
                                                            <tr>
                                        ...
                                        <div class="tab-pane fade" id="Manager_data" role="tabpanel"
                                            ...
                                            {{__('Manager Data')}}
                                            <hr>
                                            @include('employee.manager_data.tampil')
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('[data-table="manager_data"]').one('click', function (e) {
            // @include('employee.manager_data.index_js')
