                        ...
                        <form method="get" id="payment_form" class="form-horizontal" >
                               ...
                               <div class="row">
                                ...
                                <div class="col-md-6">
                                   ...
                                   {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">{{__('Nomer Rekening')}}</label>
                                        <input type="text" name="account_number" id="account_number" class="form-control" value="0" readonly="readonly">
                                    </div>
                                </div> --}}
                    ...
                    let table_table = $('#pay_list-table').DataTable({
                        ...
                        columns: [
                            ...
                            // },
                            {
                                ...
                                name: 'basic_salary',
                                render: function (data) {
                                    console.log('{{config('variable.currency')}}');
                                    console.log(formatRupiah('{{config('variable.currency')}}' + data));
                                    if ('{{config('variable.currency_format') =='suffix'}}') {
                                        // return data + ' {{config('variable.currency')}}';
                                        return formatRupiah(data + ' {{config('variable.currency')}}');
