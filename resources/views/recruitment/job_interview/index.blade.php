    ...
    <div id="acceptedModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 align="center">{{__('Are you sure you want to accept this candidate?')}}</h4>
                </div>
                <div class="modal-footer">
                    <button type="button" name="accept_button" id="accept_button" class="btn btn-danger">{{trans('file.OK')}}
                    </button>
                    <button type="button" class="close btn-default"
                            data-dismiss="modal">{{trans('file.Cancel')}}</button>
                </div>
    ...
    <script type="text/javascript">
        (function($) {  
            ...
            $(document).on('click', '.accepted', function () {
                ...
                $('#accept_button').text('{{trans('file.OK')}}');
            ...
            $('#accept_button').on('click', function () {
                let target = "{{ route('job_interviews.index') }}/" + accept_id + '/accepted';
                $.ajax({
                    url: target,
                    beforeSend: function () {
