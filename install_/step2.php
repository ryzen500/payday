        ...
        <div class='wrapper'>
            ...
            <div class="content">
                ...
                if (version_compare(PHP_VERSION, '7.2') >= 0) {
                    ...
                    $ltext .= '<i class="fa fa-close"></i>PeoplePro needs at least PHP version  7.2, Your PHP Version is: ' . PHP_VERSION . '<br/>';
                    $passed .= '0';
                }
                ...
                <br/><?php echo $ltext; ?><br/><h4>Great! System Test Completed. You can run PeoplePro on your server. Click Continue For Next Step.</h4>
